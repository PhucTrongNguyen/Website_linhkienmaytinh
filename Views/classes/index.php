...
<body>
    <div id="formInsert">
        ...
        <?php include "./Views/subview/insertLH.php"; ?>
    </div>
    <div class="formUpdate" id="formUpdate">
        <button id="buttonClose" type="button" onclick="closeForm()" class="btn btn-danger">
            <i class="fa-solid fa-xmark"></i>
        </button>
        <?php include "./Views/subview/updateLH.php"; ?>
    </div>
    <div class="wrapper">
        <?php
        ...
        <div class="main">
            ...
            <div class="text-center p-3">
                <div class="title d-flex justify-content-between align-items-center">
                    ...
                    <form action="index.php?controller=ClassController&action=searchByName" method="post">
                        <div class="input-group mb-3">
                            <input type="text" name="TenLop" class="form-control" placeholder="<?php echo postIndex('TenLop') ?? "Search" ?>">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-data-future">
                                        <a href="index.php?controller=ClassController&action=delete&MaLop=<?php echo $value['MaLop'] ?>">
                                            <i class="fa-solid fa-trash"></i>
                                        </a>
                                        <div class="buttonUpdate">
                                            <i class="fa-solid fa-pen-clip" data-id="<?php echo $value['MaLop'] ?>"></i>
                                        </div>
                                    </div>
                                </td>
                            </tr>
